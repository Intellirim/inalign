...
logger = logging.getLogger("agentshield.notifications.email")
...
class EmailNotifier(BaseNotifier):
    ...
    structured alert details, and AgentShield branding.
    """
    ...
    async def send(
        ...
        """
        from_email: str = "alerts@agentshield.io"
        ...
        payload: dict[str, Any] = {
            "personalizations": [
                {
                    "to": [{"email": to_email}],
                    "subject": f"[AgentShield] [{severity.upper()}] {title}",
                }
            ],
            "from": {"email": from_email, "name": "AgentShield"},
            "content": [
                {
                    "type": "text/html",
                    "value": html_body,
        ...
        <tr>
            <td style="background-color:#f9f9f9; padding:15px 30px;
                ...
                <p style="color:#999999; font-size:12px; margin:0;">
                    This alert was automatically generated by AgentShield.

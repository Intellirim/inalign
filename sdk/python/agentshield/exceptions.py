"""Exception classes for AgentShield SDK."""
...
class AgentShieldError(Exception):
    ...
    def __init__(
        self,
        message: str = "An error occurred with the AgentShield API.",
    ...
    @classmethod
    def from_response(cls, response: Any) -> "AgentShieldError":
        ...
        Returns:
            An appropriate AgentShieldError subclass instance.
        """
        ...
        error_map: dict[int, type[AgentShieldError]] = {
            401: AuthenticationError,
            403: AuthenticationError,
            404: NotFoundError,
            422: ValidationError,

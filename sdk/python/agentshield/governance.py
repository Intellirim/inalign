...
all agent actions through the AgentShield platform.
"""
...
class GovernanceClient(BaseClient):
    ...
    Extends the base AgentShield client with:
    ...
    Usage::
        ...
        from agentshield.governance import GovernanceClient
    ...
    def session(self, agent_id: str, session_id: Optional[str] = None):
        ...
        All actions within this context will be proxied through AgentShield.
